...
locals {
  event_types = {
    "${var.on_finalize}" : "google.storage.object.finalize"
    "${var.on_delete}" : "google.storage.object.delete"
    "${var.on_archive}" : "google.storage.object.archive"
    "${var.on_metadata_update}" : "google.storage.object.metadataUpdate"
  }
